...
L = LucidSonicDream(song = '../../ai-music-viz/audio-source/endless-ever-24-chorus1.wav',
                    pulse_audio = '../../ai-music-viz/audio-spleeted/endless-ever-24-chorus1/drums.wav', # Ignore other pulse settings and use this audio track to pulse
                    style = '../../ai-music-viz/cache/stylegan/cached-pkls/stylegan2/trypophobia.pkl')

L.hallucinate(file_name = '../../ai-music-viz/lsd-renders/endless-ever/endless-ever-chorus-1-2.mp4',
