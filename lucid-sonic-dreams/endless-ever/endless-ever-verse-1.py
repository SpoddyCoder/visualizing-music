...
L = LucidSonicDream(song = '../../ai-music-viz/audio-source/endless-ever-24-verse1.wav',
                    pulse_audio = '../../ai-music-viz/audio-spleeted/endless-ever-24-verse1/drums.wav', # Ignore other pulse settings and use this audio track to pulse
                    # motion_audio = '../../ai-music-viz/audio-spleeted/endless-ever-24-verse1/other.wav',
                    contrast_audio = '../../ai-music-viz/audio-spleeted/endless-ever-24-verse1/bass.wav',
...
L.hallucinate(file_name = '../../ai-music-viz/lsd-renders/endless-ever/endless-ever-verse-1.mp4',
