...
L = LucidSonicDream(song = '../../ai-music-viz/audio-source/endless-ever-24-intro.wav',
                    style = '../../ai-music-viz/cache/stylegan/cached-pkls/stylegan2/microscope-images.pkl')

L.hallucinate(file_name = '../../ai-music-viz/lsd-renders/endless-ever/endless-ever-intro2.mp4',
             ...
             motion_randomness = 0.1, # Between 0 and 1
